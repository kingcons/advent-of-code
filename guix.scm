;;; Advent --- Advent of code hackery
;;; Copyright © 2023 Brit Butler <brit@kingcons.io>
;;;
;;; Commentary:
;;
...
;;   guix shell
;;
;; Afterwards, start advent running a swank socket and connect via emacs:
;;
;;  > make repl
;;
;; Happy Hacking!
...
(package
  ...
  (inputs (list sbcl cl-slime-swank cl-alexandria cl-serapeum cl-mgl-pax cl-esrap cl-drakma cl-ppcre cl-screamer))
